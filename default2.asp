...
<link rel="stylesheet" href="text/storestyle2.css" type="text/css">
<link rel="stylesheet" href="text/footernav.css" type="text/css">
<link rel="stylesheet" href="text/sidenav2.css" type="text/css">
<link rel="stylesheet" href="text/design2.css" type="text/css">
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
</head>
<!--#INCLUDE FILE = "text/Background5.asp" -->

<div id="container">
    <!--#INCLUDE FILE = "include/top_nav2.asp" -->
    <div id="main">
        <%
            session("destpage")=""
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="210" class="sidenavbg" valign="top">
                    <!--#INCLUDE FILE = "include/side_nav2.asp" -->
                </td>
                <td valign="top" class="pagenavbg">
                    <!-- sl code goes here -->
                    <div id="page-content" class="plaintext">
                    <br>
                    <!--#INCLUDE FILE = "text/HomePage6.htm" -->
                    <%
