...
<html>
<head>
<title>Aussie Products.com | Quick Order Error Processing @ 2012 | Australian Products Co. Bringing Australia to You - Aussie Foods</title>
	...
	<br>
		...
		<p>&nbsp;
		  ...
		  <tr><td  class="plaintextbold">
				<span class="plaintextbold"><font color="red">
			  <ul><%=session("errmsg")%></ul>
			  <br><br>
			  </font>
			  </span>
				</td>
