...
this._id;this._objectId;this.imgPath = '/_bsImages/buttons/';this.useHelpBar;this.alignment = 'hor';this.ignoreEvents = false;this.helpBarStyle = "font-family:arial; font-size:11px; height:16px;";this._buttons = new Array;this._parentButton;this._constructor = function() {
...
out[out.length] = '<div style="background-color: menu; padding: 2px">';} else {
