...
t = new Bs_TabSet('t', 'tabset');var pickerTab = new Object;pickerTab.caption   = 'Picker';pickerTab.container = document.getElementById('ps');pickerTab.onFocus   = pickerTabFocus;pickerTab.onBlur    = pickerTabBlur;t.addTab(pickerTab);var webTab = new Object;webTab.caption   = 'Web Colors';webTab.container = document.getElementById('webSafe');webTab.onFocus   = webTabFocus;t.addTab(webTab);var myTab = new Object;myTab.caption   = 'My Colors';myTab.container = document.getElementById('tabMyColors');myTab.onFocus   = updateMyColors;t.addTab(myTab);t.draw();setColorByRgb(219, 27, 219);nf1 = new Bs_NumberField('nf1', 'rgb_r');nf1.buttonUp.imgPath   = 'img/';nf1.buttonDown.imgPath = 'img/';nf1.minValue = 0;nf1.maxValue = 255;nf1.draw();nf2 = new Bs_NumberField('nf2', 'rgb_g');nf2.buttonUp.imgPath   = 'img/';nf2.buttonDown.imgPath = 'img/';nf2.minValue = 0;nf2.maxValue = 255;nf2.draw();nf3 = new Bs_NumberField('nf3', 'rgb_b');nf3.buttonUp.imgPath   = 'img/';nf3.buttonDown.imgPath = 'img/';nf3.minValue = 0;nf3.maxValue = 255;nf3.draw();nf4 = new Bs_NumberField('nf4', 'hsb_h');nf4.buttonUp.imgPath   = 'img/';nf4.buttonDown.imgPath = 'img/';nf4.minValue = 0;nf4.maxValue = 360;nf4.draw();nf5 = new Bs_NumberField('nf5', 'hsb_s');nf5.buttonUp.imgPath   = 'img/';nf5.buttonDown.imgPath = 'img/';nf5.minValue = 0;nf5.maxValue = 100;nf5.draw();nf6 = new Bs_NumberField('nf6', 'hsb_b');nf6.buttonUp.imgPath   = 'img/';nf6.buttonDown.imgPath = 'img/';nf6.minValue = 0;nf6.maxValue = 100;nf6.draw();bs_ttt_initAll();var colorPickerCircleIcon = bsImgDir + 'cursors/colorPickerCircle.cur';document.getElementById('psColorSelector').style.cursor = colorPickerCircleIcon;document.getElementById('circle').style.cursor          = colorPickerCircleIcon;if (window.dialogArguments) {
...
if (!ie) return;var pos = getAbsolutePos(document.getElementById('psColorSelector'));document.getElementById('circle').style.left = pos.x + (hsb.y * 255);document.getElementById('circle').style.top  = pos.y + (255 - (hsb.z * 255));var hexCode = rgbArrToHexStr(rgb);var imgPath = 'img/';document.getElementById('circleImage').src = imgPath + 'circle' + ((isDarkColor(hexCode)) ? 'Light' : 'Dark') + '.gif';}
...
x = event.offsetX;y = event.offsetY;var P=Point3;hsb = P.RGBtoHSB(new Array(currentOuterR, currentOuterG, currentOuterB));var clicked_hsb_s = x / 255;var clicked_hsb_b = (255 -y) / 255;rgb = P.HSBtoRGB(new Array(hsb.x, clicked_hsb_s, clicked_hsb_b));if (rgb.x < 0) rgb.x = 0;if (rgb.y < 0) rgb.y = 0;if (rgb.z < 0) rgb.z = 0;if (!noUpdateForm) updateForm(rgb, new Array(parseInt(hsb.x * 360), parseInt(clicked_hsb_s * 100), parseInt(clicked_hsb_b * 100)));var hexCode = dechex(rgb.x) + '' + dechex(rgb.y) + '' + dechex(rgb.z);updatePreviewBox(hexCode, rgb);document.getElementById('circle').style.left = event.clientX -7;document.getElementById('circle').style.top  = event.clientY -7;var imgPath = 'img/';document.getElementById('circleImage').src = imgPath + 'circle' + ((isDarkColor(hexCode)) ? 'Light' : 'Dark') + '.gif';}
