...
var colorSelector = new Array(this.jsBaseDir + 'windowColor.html', 500, 600);var url = colorSelector[0] + '?objectId=' + this._objectId + '&id=' + this._id;url += '&callbackLoad=prepareSettings&callbackSave=setColorByPickerWindow';if (moz || (this.windowType == 'popup')) {
...
if (hex.length != 6) return false;
 sel_color = hex.toUpperCase()
 cor_img = elementId + "1.style.background='\#" + sel_color +"'" 
 eval(cor_img)
