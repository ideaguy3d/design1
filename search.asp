...
<div id="page-content">
	...
	<table width="100%" cellpadding="3" cellspacing="0" border="0"  >
		<tr><td class="TopNavRow2Text" width="100%" >Search Products</td></tr>
	</table>
	<br>
			...
			<tr>
			    <td width="10%" class="plaintextbold" align="right">				
				Search :&nbsp;
				 <td class="plaintextbold">
				 <input type="text" size="50" maxlength="256" class="plaintext" name="txtsearch" value="<%=session("searchstring")%>">
