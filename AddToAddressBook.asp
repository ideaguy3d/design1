...
<%
  if session("registeredshopper")="NO" then
  	session("destpage")="AddtoAddressBook.asp"
...
<div id="page-content">
	...
	<a class="allpage" href="FromAddress.asp?basketrecord=<%=basketrecord%>"><font color="red">Select From Address Book</font></a>
	<br>
	<br>
	OR
	<br>
	...
	<form name="custinfoform" method="POST" onSubmit="return validateForm(<%=SHIP_TOEMAIL_REQUIRED%>)" action="addaddresstobook.asp">
	<table width="100%"  border="0" cellspacing="0" cellpadding="2">
		<tr><td>
			  <input type="hidden" name="basketrecord" value="<%=basketrecord%>">
			  <input type="hidden" name="addtobook" value="1">
		</td></tr>
		<tr><td colspan="4" align="center"  class="THHeader">Add New Address &nbsp;(* Required )</td></tr>
		...
		<td class="plaintextbold" align="right"> Address 3 </td>
				<td ><input type="text" name="txtsaddress3" id="txtsaddress3" size="40,1" maxlength="40" value=""></td>
		</tr>
