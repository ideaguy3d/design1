...
<div id="header">
	<h1>
		<a href="/">
			<img src="/images/Blue-White-Banner.gif" width="780" height="100" border="0" id="home"/>
		</a>
	</h1>
<div id="topfixed">
<a href="default.asp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('home','','images/home-over.jpg',1)"></a>
					...
					<td valign="top" class="topnav1bgColor"  height="26">
						...
						<table width="50%" border="0" cellpadding="1" cellspacing="0">
							<tr>
								...
								<td>
									<a href="include/basket.asp" ><span class="TopNavText">
										<u>View Basket</u></span></a>
								</td>
								<td valign="top" align="right" class="TopNavText">				
									<table border="0" align="center">			
										<form method="POST" action="include/searchprods.asp">
											<tr>
												...
												<td>
													<input type="image" src="include/images/btn_go_green.gif" border="0" width="25" height="19">
												</td>
											</tr>
										</form>
									</table>		
