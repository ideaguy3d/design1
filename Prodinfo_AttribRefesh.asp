...
<div id="page-content">
	...
	<table width="98%"  cellpadding="3" cellspacing="0" border="0">
		<tr><td class="breadcrumbs"><a href="<%=insecureurl%>default.asp"><font class="TopNavRow2Text">Home</font></a><span class="breadcrumb-divide">&nbsp;&nbsp;&#47;&nbsp;&nbsp;</span><a href="<%=insecureurl%>specials.asp" title="Specials"><font class="breadcrumbs">Specials</font></a></td></tr>
	</table>
	<%end if %>
