...
has_backOrder_item = false
	    ...
	    retval = sitelink.TOTALORDER(session("shopperid"),session("ordernumber"),session("billtocopy"),session("shippingmethod"),basket_has_multiship)
...
shipping_for_Paypal = replace(shipping_for_Paypal,",","")
taxtotal_for_Paypal = replace(taxtotal_for_Paypal,",","")
PayPal_Order_total = replace(PayPal_Order_total,",","")
...
actual_Unitprice = replace(actual_Unitprice,",","")
