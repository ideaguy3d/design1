...
<a href="https://www.facebook.com/aussieproducts/" target="blank"><img src="http://www.niftybuttons.com/webicons2/facebook.png" width="35" height="35" /></a>&nbsp;&nbsp;
<a align="left" href="https://twitter.com/aussieproducts" target="_blank"><img src="http://www.niftybuttons.com/webicons2/twitter.png" width="35" height="35" /></a>&nbsp;&nbsp;
<a align="left" href="http://www.reddit.com/user/AussieProducts/" target="_blank"><img src="http://www.niftybuttons.com/webicons2/reddit.png" width="35" height="35" /></a>&nbsp;&nbsp;
<a align="left" href="http://www.stumbleupon.com/stumbler/AussieProducts" target="_blank"><img src="http://www.niftybuttons.com/webicons2/stumbleupon.png" width="35" height="35" /></a>&nbsp;&nbsp;
<a align="left" href="http://pinterest.com/aussieproducts/" target="_blank"><img src="http://i.imgur.com/sxwB0TO.png" width="35" height="35" /></a></p><br /><span class="sidenavTxt">
</div>


                <div class="divsearch">
                    <ul class="search-wrap">
                        <li class="searchbox"><input class="plaintext2" type="text" size="18" maxlength="256" name="txtsearch" value="Product Search" onfocus="if (this.value=='Product Search') this.value='';" onblur="if (this.value=='') this.value='Product Search';"></li>                
                        <li class="btn-go"><input type="image" src="images/btn_go2.gif" style="height:34px;border:0"></li>
